export const SearchInput = ({amount, checkValidCurrencyInputField, convertCurrency, defaultSelectedCurrency }) => {
  return (
    <div className="relative w-full">
      ...
      <button
        onClick={ () => {
          convertCurrency(defaultSelectedCurrency)
          // getAllCoins(defaultSelectedCurrency)
        }}
        type="submit"
