...
export const BottomFileSelector = ({handleFileChange, step, file}: any) => {
    ...
    <input accept=".mp3" disabled={ step == 1 ? false: true } id="file" type="file" value={file? file.name: ''} onChange={(e)=>handleFileChange(e)} className='cursor-pointerfont-["Outfit"] -mx-5 opacity-0 relative w-5 z-10' />
