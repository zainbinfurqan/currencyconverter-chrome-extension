export const ConvertButton = ({ setIsCurrencyCodeDropDownVisible, isCurrencyCodeDropDownVisible }) => {
  return (
    <div className="flex flex-col mx-2 max-[425px]:my-2 max-[425px]:items-center">
      <button
        onClick={() => setIsCurrencyCodeDropDownVisible(!isCurrencyCodeDropDownVisible)}
